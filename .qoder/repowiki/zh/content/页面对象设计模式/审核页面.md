...
- 审核按钮不可用
  ...
  - 参考：[auth.fixture.ts:10-37](file://e2e-tests/fixtures/auth.fixture.ts#L10-L37)
- 状态未更新
...
- 数据不一致
  ...
  - 参考：[api-helper.ts:134-142](file://e2e-tests/utils/api-helper.ts#L134-L142)
...
章节来源
- [report-workflow.spec.ts:38-68](file://e2e-tests/tests/regression/report-workflow.spec.ts#L38-L68)
